...
darkoperator/MSF-Installer

MSF-Installer/msf_install.sh
Carlos Perez darkoperator 26 days ago
Update msf_install.sh

8 contributors
Carlos Perez MAFLO321 Rob Fuller Matias P. Brutti Sam Gaudet Conny Brunnkvist Chris Campbell Adam Young
executable file 770 lines (715 sloc) 32.869 kb
#!/bin/bash
KVER=`uname -a`
